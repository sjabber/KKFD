...
app.get('/project/joinlist', function (req, res) {
    res.writeHead(200, { "Content-Type": "text/html" });
    fs.createReadStream("./project2/joinlist.html").pipe(res);
});

app.get('/project/bmlist', function (req, res) {
    res.writeHead(200, { "Content-Type": "text/html" });
    fs.createReadStream("./project/bmlist.html").pipe(res);
});
...
app.get('/member/mypage', function (req, res) {
    res.writeHead(200, { "Content-Type": "text/html" });
    fs.createReadStream("./member2/mypage.html").pipe(res);
});

app.get('/member/funlist', function (req, res) {
    res.writeHead(200, { "Content-Type": "text/html" });
    fs.createReadStream("./member2/funlist.html").pipe(res);
});
